    ...
    <div className="p-6 lg:p-8 max-w-[1600px] mx-auto space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
          ...
          <div key={idx} className="bg-white dark:bg-[#1C1C1E] p-6 rounded-2xl shadow-apple border border-gray-100 dark:border-white/10">
      ...
      <div className="bg-white dark:bg-[#1C1C1E] rounded-2xl shadow-apple border border-gray-100 dark:border-white/10 overflow-hidden">
