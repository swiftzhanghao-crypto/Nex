  ...
  return (
    <div className="p-6 lg:p-8 max-w-[1600px] mx-auto h-[calc(100vh-64px)] flex flex-col animate-fade-in">
      ...
      <div className="flex-1 flex gap-6 overflow-hidden min-h-0">
          <div className="w-1/3 min-w-[300px] bg-white dark:bg-[#1C1C1E] rounded-xl shadow-sm border border-gray-200 dark:border-white/10 flex flex-col">
          ...
          <div className="flex-1 bg-white dark:bg-[#1C1C1E] rounded-xl shadow-sm border border-gray-200 dark:border-white/10 flex flex-col overflow-hidden">
              {selectedDept ? (
                  <>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 animate-fade-in p-4">
          <div className="bg-white dark:bg-[#1C1C1E] rounded-xl shadow-2xl w-full max-w-md overflow-hidden flex flex-col animate-modal-enter border border-white/10">
            ...
            <div className="p-6 bg-gray-50 dark:bg-white/5 border-t border-gray-100 dark:border-white/10 flex justify-end gap-3">
              ...
              <button onClick={handleSave} className="px-4 py-2 bg-[#0071E3] dark:bg-[#FF2D55] text-white rounded-lg hover:bg-blue-600 dark:hover:bg-[#FF2D55]/80 transition font-medium shadow-md">保存</button>
            </div>
          </div>
        </div>
      )}
