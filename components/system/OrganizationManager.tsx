...
const OrganizationManager: React.FC = () => {
  const { departments, setDepartments, users } = useAppContext();
  ...
  return (
    <div className="p-4 lg:p-6 max-w-[2400px] mx-auto h-[calc(100vh-64px)] flex flex-col animate-fade-in">
      ...
      <div className="flex-1 flex gap-6 overflow-hidden min-h-0">
          <div className="unified-card w-1/3 min-w-[300px] dark:bg-[#1C1C1E] border-gray-200 dark:border-white/10 flex flex-col">
