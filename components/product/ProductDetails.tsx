                ...
                {isEditingProduct ? (
                  <div className="px-6 py-5 space-y-5">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-4">
                      ...
                      <div>
                        <label className="text-xs text-gray-500 dark:text-gray-400 mb-1.5 block font-medium">售后服务期限默认值(非周期订单)</label>
                        <input
                  ...
                  <div className="px-6 py-5">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-6 mt-6">
                      ...
                      <div>
                        <div className="text-[11px] text-gray-400 dark:text-gray-500 mb-1.5 leading-none">售后服务期限默认值(非周期订单)</div>
