  ...
  return (
    <div className="p-6 lg:p-8 max-w-[1600px] mx-auto space-y-6 animate-fade-in relative">
      ...
      <div className="space-y-6 animate-fade-in">
          {(activeTab !== 'Atomic' && activeTab !== 'Rights' && activeTab !== 'Packages' && activeTab !== 'LicenseTypes') && (
              <div className="flex justify-between items-center">
                  <div className="unified-card dark:bg-[#1C1C1E] p-2.5 border-gray-100 dark:border-white/10 flex items-center gap-3 w-80">
          ...
          {activeTab === 'LicenseTypes' && (
              <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                      {licenseDefs.map(def => (
                          <div key={def.id} className="unified-card dark:bg-[#1C1C1E] p-4 border-gray-100 dark:border-white/10 hover: transition">
              ...
              <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                      {productRights.map(right => (
                          <div key={right.id} className="unified-card dark:bg-[#1C1C1E] p-4 border-gray-100 dark:border-white/10 hover: transition">
                              <div className="flex justify-between items-start mb-2">
              ...
              <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      {rightPackages.map(pkg => (
                          <div key={pkg.id} className="unified-card dark:bg-[#1C1C1E] p-5 border-gray-100 dark:border-white/10 hover: transition">
              ...
              <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                      {atomicCapabilities.map(atom => (
                          <div key={atom.id} className="unified-card dark:bg-[#1C1C1E] p-4 border-gray-100 dark:border-white/10 hover: transition group relative">
                              <div className="flex justify-between items-start mb-2">
      ...
      {isPackageModalOpen && (
          ...
          <ModalPortal>
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-[500] animate-fade-in p-4">
              <div className="unified-card dark:bg-[#1C1C1E] shadow-2xl w-full max-w-2xl p-6 border-white/10 max-h-[90vh] flex flex-col">
