...
const OperationsManager: React.FC<OperationsManagerProps> = ({ orders, setOrders }) => {
  ...
  return (
    <div className="p-6 lg:p-8 max-w-[1600px] mx-auto space-y-8 animate-fade-in">
      ...
      <div className="unified-card dark:bg-[#1C1C1E] p-8 -gray-100/50 dark:-white/10 overflow-x-auto">
        ...
        <div className="flex items-center gap-3 w-full lg:w-auto">
          <div className="relative flex-1 lg:w-64">
            ...
            <input 
              type="text" 
              placeholder="搜索订单或客户..."
              className="unified-card w-full pl-9 pr-4 py-2 dark:bg-[#1C1C1E] -gray-200 dark:-white/10 text-sm outline-none focus:ring-2 focus:ring-blue-500/20 dark:text-white transition"
              value={searchTerm}
