    ...
    <div className="p-4 lg:p-6 max-w-[2400px] mx-auto w-full animate-page-enter pb-20 space-y-0">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          {[
              ...
              <div key={i} className="unified-card dark:bg-[#1C1C1E] -gray-100/50 dark:-white/10 p-4 flex items-center gap-3">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="md:col-span-2 space-y-4">
              ...
              {/* 基本信息 */}
              <div className="unified-card dark:bg-[#1C1C1E] p-5 -gray-100/50 dark:-white/10 space-y-0">
              ...
              {/* 联系人 */}
              <div className="unified-card dark:bg-[#1C1C1E] p-5 -gray-100/50 dark:-white/10">
          ...
          <div className="space-y-4">
              ...
              {/* 跟进计划 */}
              <div className="unified-card dark:bg-[#1C1C1E] p-5 -gray-100/50 dark:-white/10 space-y-3">
      ...
      {isContactModalOpen && (
          ...
          <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-[500] p-4 animate-fade-in">
              <div className="unified-card dark:bg-[#1C1C1E] shadow-2xl w-full max-w-lg -gray-200/50 dark:-white/10 animate-modal-enter">
