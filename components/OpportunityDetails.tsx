    ...
    <div className="flex flex-col min-h-screen bg-[#F5F5F7] dark:bg-black">
      ...
      <div className="p-6 lg:p-10 max-w-7xl mx-auto w-full space-y-8 animate-page-enter">
        ...
        {!isEditing && opportunity.stage !== 'Closed Lost' && (
            <div className="unified-card dark:bg-[#1C1C1E] p-6 -gray-100/50 dark:-white/10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
                 {/* Key Stats */}
                <div className="unified-card dark:bg-[#1C1C1E] p-6 -gray-100/50 dark:-white/10 space-y-6">
                    <div>
            ...
            <div className="md:col-span-2 space-y-6">
                <div className="unified-card dark:bg-[#1C1C1E] p-8 -gray-100/50 dark:-white/10 min-h-[400px]">
