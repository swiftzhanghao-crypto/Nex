...
const OpportunityDetails: React.FC<OpportunityDetailsProps> = ({ opportunities, setOpportunities, customers }) => {
      ...
      <div className="p-6 lg:p-10 max-w-7xl mx-auto w-full space-y-8 animate-fade-in">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
                 {/* Key Stats */}
                <div className="bg-white dark:bg-[#1C1C1E] p-6 rounded-3xl shadow-apple border border-gray-100/50 dark:border-white/10 space-y-6">
                    <div>
            ...
            <div className="md:col-span-2 space-y-6">
                <div className="bg-white dark:bg-[#1C1C1E] p-8 rounded-3xl shadow-apple border border-gray-100/50 dark:border-white/10 min-h-[400px]">
                    ...
                    <div className="space-y-6 relative pl-2">
                         ...
                         <div className="relative pl-8">
                             <div className="absolute left-0 top-1 w-4 h-4 rounded-full bg-blue-500 border-4 border-white dark:border-[#1C1C1E] shadow-sm z-10"></div>
                         ...
                         {opportunity.stage !== 'New' && (
                             <div className="relative pl-8">
                                <div className="absolute left-0 top-1 w-4 h-4 rounded-full bg-indigo-500 border-4 border-white dark:border-[#1C1C1E] shadow-sm z-10"></div>
