  ...
  return (
    <div className="p-6 space-y-6 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="unified-card flex items-center gap-2 dark:bg-[#1C1C1E] p-1 border-gray-200 dark:border-white/10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {stats.map((stat, i) => (
          <div key={i} className="unified-card dark:bg-[#1C1C1E] p-5 border-gray-200 dark:border-white/10 hover: group">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Sales Trend */}
        <div className="unified-card lg:col-span-2 dark:bg-[#1C1C1E] p-6 border-gray-200 dark:border-white/10">
        ...
        {/* Status Distribution */}
        <div className="unified-card dark:bg-[#1C1C1E] p-6 border-gray-200 dark:border-white/10">
