...
import { Product, RoleDefinition, User } from '../types';
...
const ProductCenter: React.FC<ProductCenterProps> = ({ products, currentUser, roles }) => {
  ...
  const [activeTab, setActiveTab]     = useState<'ON_SHELF' | 'ALL'>('ON_SHELF');
            ...
            {displayProducts.length > 0 ? (
              ...
              <div className="flex flex-col items-center justify-center h-full py-24 text-gray-400 dark:text-gray-600">
                ...
                <div className="text-base font-medium mb-1">
                  暂无{activeTab === 'ON_SHELF' ? '在架' : '下架'}产品
                </div>
