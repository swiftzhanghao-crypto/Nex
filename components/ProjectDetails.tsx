...
const ProjectDetails: React.FC<ProjectDetailsProps> = ({ projects, setProjects, customers }) => {
      ...
      <div className="p-6 lg:p-10 max-w-7xl mx-auto w-full space-y-8 animate-fade-in">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-2 space-y-6">
                <div className="unified-card dark:bg-[#1C1C1E] p-8 -gray-100/50 dark:-white/10 min-h-[300px]">
