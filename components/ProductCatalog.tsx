          ...
          <div className="max-w-4xl space-y-4">
            {displayProducts.length > 0 ? (
              displayProducts.map(product => (
                <div key={product.id} className="bg-white dark:bg-[#1C1C1E] border border-gray-100 dark:border-white/10 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <div className="flex items-center gap-4">
                    <button 
                      ...
                      className="bg-[#0071E3] hover:bg-blue-600 text-white px-6 py-2 rounded-lg text-sm font-medium transition-colors"
                    >
                      管理商品
                    </button>
                    <button 
