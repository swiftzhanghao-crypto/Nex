...
interface OrderManagerProps {
  ...
  standaloneEnterprises?: { id: string; name: string }[];
}
...
const OrderManager: React.FC<OrderManagerProps> = ({ orders, setOrders, products, customers, currentUser, users, departments, opportunities, channels, roles, standaloneEnterprises = [] }) => {
