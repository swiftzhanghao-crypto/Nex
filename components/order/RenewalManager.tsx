      ...
      <div className="unified-card overflow-hidden">
        ...
        <div className="flex justify-between items-center px-5 py-3.5 border-t border-gray-100/50 dark:border-white/10 bg-gray-50/30 dark:bg-white/5">
          <span className="text-xs text-gray-500 dark:text-gray-400">
            共 <span className="font-semibold text-[#0071E3] dark:text-[#0A84FF]">{filtered.length}</span> 条订阅
            {selectedIds.size > 0 && <span className="ml-2">（已选 <span className="font-semibold text-[#0071E3]">{selectedIds.size}</span> 条）</span>}
          </span>
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-1.5">
              ...
              <select
                ...
                className="unified-card h-7 pl-2 pr-6 text-xs font-medium text-gray-700 dark:text-gray-200 dark:bg-[#1C1C1E] border-gray-200 dark:border-white/10 outline-none appearance-none cursor-pointer hover:border-[#0071E3]/50 transition"
