...
import { Customer, CustomerType, CustomerLevel, CustomerContact, ContactRole } from '../../types';
    ...
    <div className="p-4 lg:p-6 max-w-[2400px] mx-auto animate-page-enter pb-2">
      ...
      {isCreateOpen && (
          ...
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-[500] p-4 animate-fade-in">
              <div className="unified-card dark:bg-[#1C1C1E] shadow-2xl w-full max-w-2xl flex flex-col animate-modal-enter border-white/10">
