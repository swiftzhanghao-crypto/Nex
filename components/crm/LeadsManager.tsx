...
import { Search, Filter, Plus, Upload, Edit, Users, RefreshCw, Settings, ChevronDown, Copy } from 'lucide-react';
...
const LeadsManager: React.FC = () => {
  ...
  return (
    <div className="page-container max-w-[1800px] space-y-2.5 animate-fade-in h-[calc(100vh-var(--layout-header-h))] flex flex-col min-w-0">
      {/* Title */}
      ...
      <div className="unified-card dark:bg-[#1C1C1E] border-gray-100 dark:border-white/10 flex-1 flex flex-col min-h-0">
        ...
        <Pagination
          ...
          total={TOTAL}
          onPageChange={goPage}
          onSizeChange={s => { setPageSize(s); setCurrentPage(1); setSelectedIds(new Set()); }}
