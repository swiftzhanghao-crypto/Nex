...
export const initialRoles: RoleDefinition[] = [
    ...
    { id: 'Finance', name: '财务 (Finance)', description: '负责合同核查、发票管理与回款确认', isSystem: true, permissions: ['dashboard_view', 'order_list_view', 'order_column_config', 'order_view_pending_approval', 'order_view_pending_confirm', 'order_view_payment', 'order_view_completed', 'order_approve', 'order_workflow_view', 'order_workflow_payment', 'order_workflow_approval', 'order_workflow_confirm', 'order_detail_product', 'order_detail_customer', 'order_detail_trader', 'order_detail_contract', 'order_detail_settlement', 'order_detail_remark', 'order_detail_log', 'customer_view', 'contract_view', 'contract_edit', 'payment_manage', 'invoice_manage', 'invoice_approve', 'remittance_view', 'authorization_view', 'delivery_info_view', 'product_display_view', 'product_view', 'performance_view'] },
...
export const initialUsers: User[] = [
    ...
    { id: 'u8', accountId: '10000008', name: '郑华 (Finance)', email: 'zhenghua@wps.cn', phone: '13800000008', role: 'Finance', userType: 'Internal', status: 'Active', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=ZhengHua', departmentId: 'c3-d1' },
