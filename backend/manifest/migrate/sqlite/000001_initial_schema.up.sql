-- 000001_initial_schema.up.sql (SQLite)
-- Complete schema matching Node.js server/db.ts
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_users_wps_user_id ON users(wps_user_id) WHERE wps_user_id IS NOT NULL;
